...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles =
    'inline-flex items-center justify-center font-medium rounded transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#0c0f14] disabled:opacity-50 disabled:cursor-not-allowed select-none';
  ...
  const variants = {
    ...
    outline: 'border border-slate-700 hover:bg-slate-800/60 text-slate-300 focus:ring-slate-600',
